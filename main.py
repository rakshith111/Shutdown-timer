...
min_entry = tk.Entry(root,textvariable = minuits,width=11, font=('calibre',10,'normal'))
sec_label = tk.Label(root, text = 'Sec', font=('calibre',10, 'bold'))
sec_entry = tk.Entry(root,textvariable = seconds,width=11, font=('calibre',10,'normal'))
